...
Pick it up and turn it, and a tilt switch auto-rotates the layout to match. Fold out the kickstand and it stands on its own at a comfortable reading angle.
...
Build your grid, configured once at infobento.com:

- **Weather** — current conditions for any location worldwide
- **Forecast** — the hours ahead at a glance
...
- **Air quality** — local AQI, pulled from Open-Meteo cloud data
- **QR code** — for your portfolio, business card, or wifi password
- **Plain text** — write your own

Mix and match. A few boxes for a calm layout, more for a dense one.
...
| -------------- | ------ | ----------------------------------------------------------- |
| **Early Bird** | $49    | One InfoBento + free worldwide shipping. First 500 backers. |
| **Standard**   | $69    | One InfoBento + free worldwide shipping.                    |
| **Gift Pair**  | $129   | Two InfoBentos + free worldwide shipping.                   |

The bill of materials runs about $45–50 at volume — the 5.76" eInk panel alone is roughly $30, and it's the cost driver. That's why InfoBento lands well under glowing smart displays while still feeling like a finished object.
...
**How often does the screen change?** Once or twice a day, by design. eInk holds the last frame with zero power, so a still screen costs nothing.
