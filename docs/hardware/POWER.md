...
- **Form factor:** countertop bento device. Front: Good Display GDEH0576T81 5.76" B&W eInk (920×680, 198 DPI, SSD2677, 2-bit grayscale). Back-upper: solar panel. Back/side: ESP32-C3, LiPo, charging port, pinhole reset. A fold-out kickstand props the device at a viewing tilt on the countertop.
