...
const SRC_ICONS: Record<string, readonly number[]> = {
  ...
  // uv: Half sun over a horizon with rays beaming down. Deliberately unlike the
  // `weather` sun, which is a full disc with rays all round.
  uv: [
    0b00000000000000,
    0b00000111100000,
    0b00011111111000,
  ...
  // pollen: Four-petal flower with a round centre
  pollen: [
    0b00000000000000,
    0b00001100110000,
    0b00011100011100,
  ...
  // onthisday: Document page with text lines
  onthisday: [
    0b00111111111100,
    0b00100000000100,
    0b00101111110100,
